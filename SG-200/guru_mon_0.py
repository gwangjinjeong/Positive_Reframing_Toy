...
monLists = [
        ...
        [u'종료',       '0'],
        [u'구루 안녕','start'], # 파이리
        [u'파이리 불 발사', '1'] # 파이리 불 발사
        [u'난 멋진 사람이야', '2'], # 파이리 진화 후 리자드
        [u'사랑해 사랑해 사랑해', '3'], # 리자드 진화 리자몽
        [u'오늘이야말로 내 생애 최고의 날이 된다','4'], # 리자몽 진화 메가 리자몽
        ]
minionsLists = [
    #명령어    대답    종료 리턴값
        [u'종료',       '안녕 다음에봐'],
